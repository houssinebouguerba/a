...
class Ui_TestWidget(object):
    def setupUi(self, TestWidget):
        TestWidget.setObjectName("Dashboard")
        #TestWidget.resize(703, 350)
        self.horizontalLayout = QtWidgets.QHBoxLayout(TestWidget)
        self.horizontalLayout.setContentsMargins(11, 120, 11, 100)
        ...
        self.RoundBar1 = QRoundProgressBar(TestWidget)
        #palette5 = QtGui.QPalette()

        #self.RoundBar1.setPalette(palette5)
        self.RoundBar1.setObjectName("RoundBar1")
        self.RoundBar1.setStyleSheet(" background-color: rgb(23, 32, 42); ")

        
        self.gridLayout_3.addWidget(self.RoundBar1, 1, 0, 1, 1)
        
        self.RoundBar2 = QRoundProgressBar(TestWidget)
        self.RoundBar2.setObjectName("RoundBar2")
        self.gridLayout_3.addWidget(self.RoundBar2, 2, 0, 1, 1)


        self.RoundBar3 = QRoundProgressBar(TestWidget)
        self.RoundBar3.setObjectName("RoundBar3")
        self.gridLayout_3.addWidget(self.RoundBar3, 3, 0, 1, 1)

        
        self.RoundBar4 = QRoundProgressBar(TestWidget)
        self.RoundBar4.setObjectName("RoundBar4")
        self.gridLayout_3.addWidget(self.RoundBar4, 4, 0, 1, 1)


        self.RoundBar5 = QRoundProgressBar(TestWidget)
        self.RoundBar5.setObjectName("RoundBar5")
        self.gridLayout_3.addWidget(self.RoundBar5, 1, 1, 1, 1)
        
        self.RoundBar6 = QRoundProgressBar(TestWidget)
        self.RoundBar6.setObjectName("RoundBar6")
        self.gridLayout_3.addWidget(self.RoundBar6, 2, 1, 1, 1)


        self.RoundBar7 = QRoundProgressBar(TestWidget)
        self.RoundBar7.setObjectName("RoundBar7")
        self.gridLayout_3.addWidget(self.RoundBar7, 3, 1, 1, 1)
        
        self.RoundBar8 = QRoundProgressBar(TestWidget)
        #palette5 = QtGui.QPalette()

        #self.RoundBar1.setPalette(palette5)
        self.RoundBar8.setObjectName("RoundBar8")
        self.RoundBar8.setStyleSheet(" background-color: rgb(23, 32, 42); ")
        self.gridLayout_3.addWidget(self.RoundBar8, 4, 1, 1, 1)
        
        

        
        self.RoundBar9 = QRoundProgressBar(TestWidget)
        self.RoundBar9.setObjectName("RoundBar9")
        self.gridLayout_3.addWidget(self.RoundBar9, 1, 2, 1, 1)


        self.RoundBar10 = QRoundProgressBar(TestWidget)
        self.RoundBar10.setObjectName("RoundBar10")
        self.gridLayout_3.addWidget(self.RoundBar10, 2, 2, 1, 1)

        
        self.RoundBar11 = QRoundProgressBar(TestWidget)
        self.RoundBar11.setObjectName("RoundBar11")
        self.gridLayout_3.addWidget(self.RoundBar11, 3, 2, 1, 1)


        self.RoundBar12 = QRoundProgressBar(TestWidget)
        self.RoundBar12.setObjectName("RoundBar12")
        self.gridLayout_3.addWidget(self.RoundBar12, 4, 2, 1, 1)
        
        self.RoundBar13 = QRoundProgressBar(TestWidget)
        self.RoundBar13.setObjectName("RoundBar13")
        self.gridLayout_3.addWidget(self.RoundBar13, 1, 3, 1, 1)


        self.RoundBar14 = QRoundProgressBar(TestWidget)
        self.RoundBar14.setObjectName("RoundBar14")
        self.gridLayout_3.addWidget(self.RoundBar14, 2, 3, 1, 1)

        self.RoundBar15 = QRoundProgressBar(TestWidget)
        self.RoundBar15.setObjectName("RoundBar14")
        self.gridLayout_3.addWidget(self.RoundBar15, 3, 3, 1, 1)


        self.RoundBar16 = QRoundProgressBar(TestWidget)
        self.RoundBar16.setObjectName("RoundBar14")
        self.gridLayout_3.addWidget(self.RoundBar16, 4, 3, 1, 1)

        self.RoundBar_total = QRoundProgressBar_total(TestWidget)
        palette = QtGui.QPalette()
        ...
        self.RoundBar_total.setObjectName("RoundBartotal")
        self.gridLayout_3.addWidget(self.RoundBar_total, 2, 4, 2, 2)
    ...
    def retranslateUi(self, TestWidget):
        ...
        TestWidget.setWindowTitle(_translate("TestWidget", "Dashboard"))
